import{_ as r,c as t,b as n,a as p,d as a,w as l,r as d,o,e as i}from"./app-CU3PtqxC.js";const c={},v={class:"table-of-contents"};function u(m,s){const e=d("router-link");return o(),t("div",null,[s[4]||(s[4]=n("h1",{id:"在组件中-v-model-props-属性时-报错了怎么解决",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#在组件中-v-model-props-属性时-报错了怎么解决"},[n("span",null,"在组件中，v-model props 属性时，报错了怎么解决")])],-1)),s[5]||(s[5]=n("p",null,"目录",-1)),n("nav",v,[n("ul",null,[n("li",null,[a(e,{to:"#当v-model-propsval-时-警告"},{default:l(()=>s[0]||(s[0]=[i('当v-model="propsVal"时,警告')])),_:1})]),n("li",null,[a(e,{to:"#方法一-利用data"},{default:l(()=>s[1]||(s[1]=[i("方法一：利用data")])),_:1})]),n("li",null,[a(e,{to:"#方法二-利用计算属性"},{default:l(()=>s[2]||(s[2]=[i("方法二：利用计算属性")])),_:1})]),n("li",null,[a(e,{to:"#方法三-利用watch"},{default:l(()=>s[3]||(s[3]=[i("方法三：利用watch")])),_:1})])])]),s[6]||(s[6]=p(`<h2 id="当v-model-propsval-时-警告" tabindex="-1"><a class="header-anchor" href="#当v-model-propsval-时-警告"><span>当v-model=&quot;propsVal&quot;时,警告</span></a></h2><div class="hint-container warning"><p class="hint-container-title">警告信息</p><p>  [Vue warn]: Avoid mutating a prop directly since the value will be overwritten whenever the parent component re-renders. Instead, use a <strong>data</strong> or <strong>computed</strong> property <strong>based on the prop&#39;s value</strong>. Prop being mutated: &quot;propsVal&quot;</p></div><p>之所以会警告，是因为破坏了<strong>单向数据流</strong>，建议看看官方文档：</p><ul><li>vue2: <a href="https://v2.cn.vuejs.org/v2/guide/components-props.html#%E5%8D%95%E5%90%91%E6%95%B0%E6%8D%AE%E6%B5%81" target="_blank" rel="noopener noreferrer">Prop — Vue.js (vuejs.org) 单向数据流</a></li><li>vue3: <a href="https://cn.vuejs.org/guide/components/props.html#one-way-data-flow" target="_blank" rel="noopener noreferrer">Props | Vue.js (vuejs.org) 单向数据流</a></li></ul><p>假定在组件中,使用<strong>v-model = &quot;modelVal&quot;</strong>，根据官方提示信息和官方文档，可以有方法一和方法二：</p><h2 id="方法一-利用data" tabindex="-1"><a class="header-anchor" href="#方法一-利用data"><span>方法一：利用data</span></a></h2><div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue"><pre><code><span class="line">  // 缺点：当propsVal改变时，modelVal并不会随propsVal的改变而改变</span>
